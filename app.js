...
function Chutar() {
  do {
    ...
    if (qtd >= 3 && chute != nSecret) {
      ...
      valor.style.color = "white";
      document.getElementById("valor").disabled = true;
      let btt = (document.getElementById("btC").disabled = true);
    } else if (chute > 10 || chute < 0) {
      alert(`Digite um número entre 0 e 10. Restam ${3 - qtd} tentativa(s)`);
      valor.value = "";
      valor.focus();
    } else if (chute > nSecret) {
      resultado.innerHTML = `Número muito alto...<br>Escolha outro!<br>Restam ${
        3 - qtd
      } tentativa(s)`;
      valor.value = "";
      valor.focus();
      ...
      resultado.innerHTML = `Número muito baixo...<br>Escolha outro!<br>Restam ${
        3 - qtd
      } tentativa(s)`;
      valor.value = "";
      valor.focus();
